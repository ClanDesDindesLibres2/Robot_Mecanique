...
* *Optional* The top piece is then placed face down in the cutter to engrave the guide lines for the electrical diagram on the bottom of the [top](https://github.com/ClanDesDindesLibres2/RoboticArm_ChessBoard_Mechanic/blob/main/Mechanical/WoodenBox/top.svg)  file.
...
* *Additional* The last part to this wooden box is a drawer.
...
* The following instructions explain the conception of the drawer inside the box.
    #### Drawer
